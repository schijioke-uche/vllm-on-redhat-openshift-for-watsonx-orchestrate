...
# Some vendor images expose the OpenAI API server as a Python module but do not
# place the `vllm` console script on PATH. Preserve the same argument contract
# as `vllm serve` and fall back to the module entrypoint.
